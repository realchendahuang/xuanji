/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 66cd8b555780ee3fe1751a03d21fc01c)
...
interface __BaseEnv_Env {
  ...
  DB: D1Database
  CF_ACCOUNT_ID: '4637564ffe56fa1147f68c2c3a7d4772'
  AI_GATEWAY_ID: 'xuanji'
  AI_PROVIDER: 'deepseek'
  AI_MODEL: 'deepseek-v4-flash'
  XuanJiAgent: DurableObjectNamespace /* ThinkAgent_Xuanji */
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./worker')
    durableNamespaces: 'ThinkAgent_Xuanji'
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'CF_ACCOUNT_ID' | 'AI_GATEWAY_ID' | 'AI_PROVIDER' | 'AI_MODEL'
    >
  > {}
}
