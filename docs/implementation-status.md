...
| Dedicated AI Gateway         | `AI_GATEWAY_ID=xuanji`; production model calls use `WorkersAIGatewayAdapter`.                                         |
...
| Streaming AI                 | `/api/v1/readings/stream` emits SSE status and the completed report through Gateway `xuanji`.                         |
